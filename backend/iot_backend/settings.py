...
SECRET_KEY = 'django-insecure-2(!#6(ki^14#xhq+d)-r!*3a)=yx01+hr6npko!lp(q%az9gs#'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=1),  # 24-hour token for development testing convenience
...
DEFAULT_FROM_EMAIL = 'IoT InFo <admin7020@gmail.com>'
